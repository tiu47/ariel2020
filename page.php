...
<body>
	...
	if (boolval($mobile) == False) {
		echo "<h1>" . var_dump($mobile) . "</h1>";
		echo  '<canvas id="webpageline" data-processing-sources="' . esc_url(get_template_directory_uri() . '/web_page_line.js') . '"></canvas>';
	}
							...
							<div class=" col-sm-12 col-md-4 bttt me-2 ">
								<div class="row ">
									<div class="col-3  border-top  text-center">
										<h3 class="animate__animated animate__bounce">UX</h3>
									</div>
		...
		<div class="row">
			<div class="container">
				...
				<div class="row   justify-content-md-center">
					...
					// $allPostsWPQuery = new WP_Query(array('post_type'=>'post'));
